  ...
  return (
    <div>
      <div className="relative flex mx-auto mb-10 flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0">
        <div className="relative inset-y-0 top-0 right-0 z-0 w-full mb-10 max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-7/12 lg:max-w-full lg:absolute xl:px-0">
          <svg
